...
{
    internal class SortedOrderList<T> where T : IComparable
    {
        private Node<T> head;
        ...
        public void RevSort()
        {
            ...
            while (current != null)
            {
                ...
                while (index != null)
                {
                    ...
                    if (1 == ((index.data).CompareTo(current.data)))
                    {
                        dynamic temp = current.data;
        ...
        public void Run()
        {
            ...
            while (flag)
            {
                ...
                Console.WriteLine("12 : Reverse Sort Linked List");
                ...
                switch (option)
                {
                    ...
                    case 12:
                        ...
                        Console.BackgroundColor = ConsoleColor.White;
                        Console.ForegroundColor = ConsoleColor.DarkRed;
                        Console.Write("REVERSE SORT LINKED LIST");
                        Console.ResetColor();
                        Console.WriteLine(" }---------------\n");
                        Console.WriteLine("Un-sorted Linked List\n");
                        display();
